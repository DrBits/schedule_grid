...
export const patients: Patient[] = [
    new Patient("Иван Иванович Иванов", moment("2011-11-11").toDate(), "1111111111111111"),
    new Patient("Алексей Алексеевич Алексеев", moment("1922-12-22").toDate(), "2222222222222222"),
    new Patient("Петр Петрович Петров", moment("1990-01-01").toDate(), "3333333333333333"),
    new Patient("Сергей Сергеевич Сергеев", moment("2002-02-02").toDate(), "4444444444444444"),
    new Patient("Василий Васильевич Васильев", moment("1949-09-09").toDate(), "5555555555555555")
]
