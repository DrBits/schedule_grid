...
export const patients: Patient[] = [
    new Patient("Иван Иванович Иванов", "Иванов И. И.", moment("2011-11-11").toDate(), "1111111111111111"),
    new Patient("Алексей Алексеевич Алексеев", "Алексеев А. А.", moment("1922-12-22").toDate(), "2222222222222222"),
    new Patient("Петр Петрович Петров", "Петров П. П.", moment("1990-01-01").toDate(), "3333333333333333"),
    new Patient("Сергей Сергеевич Сергеев", "Сергеев С. С", moment("2002-02-02").toDate(), "4444444444444444"),
    new Patient("Василий Васильевич Васильев", "Васильев В. В.", moment("1949-09-09").toDate(), "5555555555555555")
]
